...
//	}
    ...
    public static String getRandomFileName(String originalFilename, String moduleName){
         if(StringUtils.isBlank(originalFilename)){
            throw new MException(MExceptionEnum.FILE_READING_ERROR);
         }

         moduleName = moduleName == null ? "default": moduleName.trim();

         StringBuilder randName = new StringBuilder();
         randName.append(moduleName);
         randName.append("_");
         randName.append(getRandomString(6));
         randName.append(".");
         randName.append(getFileSuffix(originalFilename));
