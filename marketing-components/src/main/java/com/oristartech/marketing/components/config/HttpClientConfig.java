...
import com.oristartech.marketing.components.config.properties.HttpClientProperties;
/**
 * @author wangweiheng
...
public class HttpClientConfig {
    ...
    @ConditionalOnMissingBean(PoolingHttpClientConnectionManager.class)//容器中如果没有这个类,那么自动配置这个类
