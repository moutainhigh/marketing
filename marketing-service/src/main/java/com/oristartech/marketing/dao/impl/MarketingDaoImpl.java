...
public class MarketingDaoImpl extends RuleBaseDaoImpl<MarketingActivity, Long> implements IMarketingDao {
	...
	public Page findEngineExeRuleVOs(RuleSearchCondition searchCondition) {
		...
		sql.append(" 		activity.TENANT_ID tenantId, ");
		sql.append(" 		rg.id id, ");
		sql.append(" 		rs.id ruleSectionVO_id, ");
		sql.append(" 		rg.CREATE_DATE createDate, ");
		sql.append(" 		rg.EXECUTE_MODE executeMode, ");
		sql.append(" 		rg.MODIFY_DATE modifyDate, ");
		sql.append(" 		rg.NAME name, ");
		sql.append(" 		rg.PRIORITY priority, ");
		sql.append(" 		rg.RELATE_BUSINESS_CODE bizOrderCode, ");
		sql.append(" 		rg.REMARK remark, ");
		sql.append(" 		rg.RULE_TYPE ruleType, ");
		sql.append(" 		rg.STATUS status ,");
		sql.append(" 		rg.TEMPLATE_ID templateId, ");
		sql.append(" 		rg.VALID_DATE_END validDateEnd, ");
		sql.append(" 		rg.VALID_DATE_START validDateStart, ");
		sql.append(" 		rs.IS_SERIAL ruleSectionVO_isSerial, ");
		sql.append(" 		rs.RULE_ID ruleSectionVO_ruleId, ");
		sql.append(" 		rs.RULE_GROUP_ID ruleSectionVO_ruleGroupId, ");
		sql.append(" 		rs.SEQ_NUM ruleSectionVO_seqNum  ");
